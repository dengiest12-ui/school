...
4. Данные ребенка, файлы и семейные связи скрываются сразу по scope, удаление аккаунта получает 7 дней grace period.
5. Отмена возможна только до конца grace period и только после повторной авторизации.
