...
| Дизайн-прототип | `[~]` | 1 | Есть базовый SwiftUI-каркас 5 главных вкладок; 8 экранов прототипа еще не закрыты. |
| iOS-приложение | `[~]` | 3 | Создан `SchoolApp.xcodeproj`, сборка проходит на iPhone 17 Simulator. |
...
- [ ] Экран "Сегодня / Что завтра"
  ...
  - Уровень: 0
  - Артефакт:
  - Комментарий: главный экран продукта
