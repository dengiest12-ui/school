...
- [~] Карточка "Что завтра?"
  ...
  - Уровень: 3
  - Артефакт: `.build/screenshots/schedule-today-final.png`
  - Комментарий: показывает уроки на завтра, форму и личный кружок; ДЗ, срочные задачи и события пока живут отдельными локальными блоками без единого backend-дайджеста
...
- [~] Быстрые действия
  ...
  - Комментарий: быстрые кнопки показывают ДЗ, кружок, событие, сбор, расписание и чат; часть кнопок пока открывает локальные прототипы, не общие бизнес-сценарии
