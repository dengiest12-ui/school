...
- [~] Общий чат класса
  ...
  - Комментарий: есть локальные ветки чатов, сообщения, непрочитанные, быстрый ответ, системный выбор файла, фото-пометка, отображение вложений, действия из важных сообщений, закрепленные сообщения и реакции со счетчиками; голосовые, хранение бинарных файлов и backend не подключены
