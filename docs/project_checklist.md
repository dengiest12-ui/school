...
| Дизайн-прототип | `[~]` | 3 | Выбран первый дизайн-референс и перенесен в SwiftUI на 5 главных вкладок; нужна ручная визуальная приемка. |
| iOS-приложение | `[~]` | 3 | Создан `SchoolApp.xcodeproj`, обновленный дизайн собирается на iPhone 17 Simulator. |
| Backend / синхронизация | `[ ]` | 0 | Нужно выбрать подход: backend-first или локальная модель + синхронизация. |
| AI-разбор фото/текста | `[ ]` | 0 | ДЗ по фото и разбор хаоса - ключевая ценность. |
...
- [x] Информационная архитектура
  ...
  - Уровень: 3
  - Артефакт: `SchoolApp/App/AppTab.swift`
  - Комментарий: навигация реализована в iOS Tab Bar
...
- [~] Визуальный стиль
  ...
  - Комментарий: первый дизайн выбран как основной; нужна визуальная приемка владельцем
...
- [~] Экран "Сегодня / Что завтра"
  ...
  - Комментарий: реализованы ребенок, "Что завтра", срочное, ДЗ, расписание, чаты и быстрые действия; нужна ручная проверка на экране
...
- [~] Экран "Класс / Лента"
  ...
  - Комментарий: реализованы вкладки ленты, чатов, сборов, фото и участников на тестовых данных
...
- [~] Экран "Календарь / событие"
  ...
  - Комментарий: реализованы ближайшие события, неделя и личные кружки на тестовых данных
...
- [ ] ДЗ по фото
  ...
  - Уровень: 0
  - Артефакт:
  - Комментарий: одна из главных AI-функций MVP
...
- [~] Проверка на iPhone Simulator
  ...
  - Уровень: 3
  - Артефакт: `xcodebuild ... iPhone 17`
  - Комментарий: сборка проходит; ручной визуальный прогон вкладок еще нужен
